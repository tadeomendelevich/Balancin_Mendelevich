...
- **Última sesión:** 2026-09-21 (display y transporte USB extraidos de main; Debug/Release y tests host verificados; pendiente prueba fisica)
...
- **Transporte USB aislado (2026-09-21):** `comunicacion_usb.c` conserva la cola y el buffer persistente requerido por CDC. UNER mantiene el protocolo compartido USB/WiFi; el controlador conserva el armado de telemetria. Los consumidores incluyen una sola API en vez de repetir prototipos `extern`.
